...
AWS best practice is to create separate dedicated AWS accounts for various purposes.  Here's an example:
- root/management
- security
- shared
- audit
